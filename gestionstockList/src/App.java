    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
               ...
               switch (choix) {
                ...
                break;
                case 2:
                       ArrayList<Categorie>  categories=CategorieService.getAllCategories();
                       GestionnaireView.afficheCategorie(categories);
                break;

                 case 3:
                        
                       categories=CategorieService.getAllCategories();
                       Produit produit=GestionnaireView.saisieProduit(categories);
                ...
                break;
                 ...
                 case 4:
                      ArrayList<Produit> produits=ProduitService.getAllProduits();
                       GestionnaireView.afficheProduit(produits);
                break;
